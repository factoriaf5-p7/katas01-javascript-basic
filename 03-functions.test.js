...
describe("Funciones en JavaScript", () => {
    ...
    it("Las funciones pueden tener múltiples parámetros", () => {
      ...
      assert.strictEqual(
      weatherReport(userName, name, city, weather, rainProbability),"Hola Ada Martín (ada89), hoy en Las Vegas el tiempo es soleado y las probabilidades de lluvia son del 10%."
    );
    })
    ...
    it("Bonus: UserAuth funcion", () => {
        ...
        assert.strictEqual(
        userAuth(userName, userEmail, password),"Welcome ${userName}, your email is ${userEmail} and your password is ${password}." 
      );
    })
